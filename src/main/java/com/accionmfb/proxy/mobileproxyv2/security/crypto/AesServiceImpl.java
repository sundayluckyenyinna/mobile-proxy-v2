...
public class AesServiceImpl implements AesService {
    ...
    public String doEncryption(String strToEncrypt){
        return this.encryptFlutterString(strToEncrypt, aesEncryptionKey);
    }

    @Override
    public String doDecryption(String strToDecrypt) {
        return this.decryptFlutterString(strToDecrypt, aesEncryptionKey);
    }
    ...
    public ValidationPayload validateRequest(GenericPayload genericRequestPayload) {
        ...
        OmnixResponsePayload exResponse = new OmnixResponsePayload();
